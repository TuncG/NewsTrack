...
const Microsoft = () => {
  ...
  const fetchNews = async function (search) {
    ...
    const apiParams = "&q=Google&from=" + yesterdayDate + "&sortBy=popularity";
  ...
  return (
    <>
      {alert}
      <SimpleHeader section="Microsoft page " subsection="Tables" />
      {/* Page content */}
      <Container
        maxWidth={false}
        component={Box}
                ...
                subheader={
                  ...
                  >
                    <Grid item xs="auto" md={12} style={{ display: "flex" }}>
                      ...
                      >
                        <Box component="span">Microsoft Article Table</Box>
                      </Box>
                      <Box
                        component="p"
                        fontSize=".875rem"
                        ...
                        fontWeight="500"
                      >
                        Find all the recent mentions of Microsoft in recent
